...
{
	cout << "Jak uruchomic programuu:" << endl << "-o plikwy.txt -k enpl -s slownik.txt -i plikwe.txt";
}
...
void tlumacz(const string & si, const string & so, const string & ss, const string & sk)  //G³owna funkcja t³umaczy tekst
{
	ifstream pli;			//WEJ
	ofstream plo;			//WYJ
